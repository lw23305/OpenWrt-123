...
#  clone -b luci-smartdns-dev --single-branch https://github.com/xiaorouji/openwrt-passwall.git package/luci-app-passwall
...
sed -i "s/${orig_version}/R${date_version} by lw330/g" package/lean/default-settings/files/zzz-default-settings
